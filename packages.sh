...
export PKG_EXPAT=https://prdownloads.sourceforge.net/expat/expat-2.7.1.tar.xz
...
export PKG_GCC=https://mirrors.ocf.berkeley.edu/gnu/gnu/gcc/gcc-15.2.0/gcc-15.2.0.tar.xz
...
export PKG_LIBXCRYPT=https://github.com/besser82/libxcrypt/releases/download/v4.4.38/libxcrypt-4.4.38.tar.gz
...
export PKG_UTILLINUX=https://www.kernel.org/pub/linux/utils/util-linux/v2.38/util-linux-2.41.1.tar.xz
...
export PKG_ZLIB=https://zlib.net/fossils/zlib-1.3.1.tar.xz
...
export PATCH_COREUTILSINTL=https://www.linuxfromscratch.org/patches/lfs/12.4/coreutils-9.7-il8n-1.patch
