...
PKG_EXPECT=https://prdownloads.sourceforge.net/expect/expect5.45.4.tar.gz
...
PKG_LIBCAP=https://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.63.tar.xz
...
PKG_PYTHONDOCS=https://www.python.org/ftp/python/doc/3.10.2/python-3.10.2-docs-html.tar.bz2
...
PKG_UNIFONT=https://unifoundry.com/pub/unifont/unifont-14.0.01/font-builds/unifont-14.0.01.pcf.gz
